...
resource "aws_api_gateway_integration" "actionrenkeikeydeletebuild-post" {
  ...
  request_templates = {
    "application/json": "#set( $body = $util.escapeJavaScript($input.json('$')) )\r\n{\r\n    \"input\": \"$body\",\r\n    \"stateMachineArn\": \"arn:aws:states:ap-northeast-1:505982390831:stateMachine:ActionRenkeiKeyDeleteBuild\"\r\n} "
  }
}
...
resource "aws_api_gateway_integration" "actionrenkeikeyeditoptionalitem-post" {
  ...
  passthrough_behavior    = "WHEN_NO_TEMPLATES"
  request_templates = {
    "application/json": "#set( $body = $util.escapeJavaScript($input.json('$')) )\r\n{\r\n    \"input\": \"$body\",\r\n    \"stateMachineArn\": \"arn:aws:states:ap-northeast-1:505982390831:stateMachine:ActionRenkeiKeyEditOptionalItem\"\r\n} "
  }
}
...
resource "aws_api_gateway_integration" "actionrenkeikeyeditrenkeikey-post" {
  ...
  passthrough_behavior    = "WHEN_NO_TEMPLATES"
  request_templates = {
    "application/json": "#set( $body = $util.escapeJavaScript($input.json('$')) )\r\n{\r\n    \"input\": \"$body\",\r\n    \"stateMachineArn\": \"arn:aws:states:ap-northeast-1:505982390831:stateMachine:ActionRenkeiKeyEditRenkeiKey\"\r\n} "
   }
}
...
resource "aws_api_gateway_integration" "checkeditkey-post" {
  ...
  integration_http_method = "POST"
  type                    = "AWS_PROXY"
  uri                     = "arn:aws:apigateway:ap-northeast-1:lambda:path/2015-03-31/functions/arn:aws:lambda:ap-northeast-1:505982390831:function:CheckEditKey/invocations"
...
resource "aws_api_gateway_integration" "checkloadrenkeikey-post" {
  ...
  passthrough_behavior    = "WHEN_NO_TEMPLATES"
  request_templates = {
    "application/json": "#set( $body = $util.escapeJavaScript($input.json('$')) )\r\n{\r\n    \"input\": \"$body\",\r\n    \"stateMachineArn\": \"arn:aws:states:ap-northeast-1:505982390831:stateMachine:CheckLoadRenkeiKey\"\r\n} "
  }
}
...
resource "aws_api_gateway_integration" "createcsv-post" {
  ...
  integration_http_method = "POST"
  type                    = "AWS_PROXY"
  uri                     = "arn:aws:apigateway:ap-northeast-1:lambda:path/2015-03-31/functions/arn:aws:lambda:ap-northeast-1:505982390831:function:CreateCsv/invocations"
  credentials             = "arn:aws:iam::505982390831:role/shusys-API-Lambda-role"
  passthrough_behavior    = "WHEN_NO_MATCH"
}
...
resource "aws_api_gateway_integration" "deletebuild-post" {
  ...
  integration_http_method = "POST"
  type                    = "AWS_PROXY"
  uri                     = "arn:aws:apigateway:ap-northeast-1:lambda:path/2015-03-31/functions/arn:aws:lambda:ap-northeast-1:505982390831:function:DeleteBuild/invocations"
  credentials             = "arn:aws:iam::505982390831:role/shusys-API-Lambda-role"
  passthrough_behavior    = "WHEN_NO_MATCH"
}
...
resource "aws_api_gateway_integration" "editfreekey-post" {
  ...
  integration_http_method = "POST"
  type                    = "AWS_PROXY"
  uri                     = "arn:aws:apigateway:ap-northeast-1:lambda:path/2015-03-31/functions/arn:aws:lambda:ap-northeast-1:505982390831:function:EditFreeKey/invocations"
  credentials             = "arn:aws:iam::505982390831:role/shusys-API-Lambda-role"
  passthrough_behavior    = "WHEN_NO_MATCH"
}
...
resource "aws_api_gateway_integration" "editrenkeikey-post" {
  ...
  integration_http_method = "POST"
  type                    = "AWS_PROXY"
  uri                     = "arn:aws:apigateway:ap-northeast-1:lambda:path/2015-03-31/functions/arn:aws:lambda:ap-northeast-1:505982390831:function:EditRenkeiKey/invocations"
  credentials             = "arn:aws:iam::505982390831:role/shusys-API-Lambda-role"
  passthrough_behavior    = "WHEN_NO_MATCH"
}
...
resource "aws_api_gateway_integration" "gethistoryassessment-post" {
  ...
  integration_http_method = "POST"
  type                    = "AWS_PROXY"
  uri                     = "arn:aws:apigateway:ap-northeast-1:lambda:path/2015-03-31/functions/arn:aws:lambda:ap-northeast-1:505982390831:function:GetHistoryAssessment/invocations"
  credentials             = "arn:aws:iam::505982390831:role/shusys-API-Lambda-role"
  passthrough_behavior    = "WHEN_NO_MATCH"
}
...
resource "aws_api_gateway_integration" "gethistoryprospect-post" {
  ...
  integration_http_method = "POST"
  type                    = "AWS_PROXY"
  uri                     = "arn:aws:apigateway:ap-northeast-1:lambda:path/2015-03-31/functions/arn:aws:lambda:ap-northeast-1:505982390831:function:GetHistoryProspect/invocations"
  credentials             = "arn:aws:iam::505982390831:role/shusys-API-Lambda-role"
  passthrough_behavior    = "WHEN_NO_MATCH"
}
...
resource "aws_api_gateway_integration" "gettksd-post" {
  ...
  integration_http_method = "POST"
  type                    = "AWS_PROXY"
  uri                     = "arn:aws:apigateway:ap-northeast-1:lambda:path/2015-03-31/functions/arn:aws:lambda:ap-northeast-1:505982390831:function:GetTksd/invocations"
  credentials             = "arn:aws:iam::505982390831:role/shusys-API-Lambda-role"
  passthrough_behavior    = "WHEN_NO_MATCH"
}
...
resource "aws_api_gateway_integration" "gettkyd-post" {
  ...
  integration_http_method = "POST"
  type                    = "AWS_PROXY"
  uri                     = "arn:aws:apigateway:ap-northeast-1:lambda:path/2015-03-31/functions/arn:aws:lambda:ap-northeast-1:505982390831:function:GetTkyd/invocations"
  credentials             = "arn:aws:iam::505982390831:role/shusys-API-Lambda-role"
  passthrough_behavior    = "WHEN_NO_MATCH"
}
...
resource "aws_api_gateway_integration" "revivebuild-post" {
  ...
  integration_http_method = "POST"
  type                    = "AWS_PROXY"
  uri                     = "arn:aws:apigateway:ap-northeast-1:lambda:path/2015-03-31/functions/arn:aws:lambda:ap-northeast-1:505982390831:function:ReviveBuild/invocations"
  credentials             = "arn:aws:iam::505982390831:role/shusys-API-Lambda-role"
  passthrough_behavior    = "WHEN_NO_MATCH"
}
...
resource "aws_api_gateway_integration" "SearchAssessmentAndProspect-post" {
  ...
  integration_http_method = "POST"
  type                    = "AWS_PROXY"
  uri                     = "arn:aws:apigateway:ap-northeast-1:lambda:path/2015-03-31/functions/arn:aws:lambda:ap-northeast-1:505982390831:function:SearchAssessmentAndProspect/invocations"
  credentials             = "arn:aws:iam::505982390831:role/shusys-API-Lambda-role"
  passthrough_behavior    = "WHEN_NO_MATCH"
}
...
resource "aws_api_gateway_integration" "storetksd-post" {
  ...
  integration_http_method = "POST"
  type                    = "AWS_PROXY"
  uri                     = "arn:aws:apigateway:ap-northeast-1:lambda:path/2015-03-31/functions/arn:aws:lambda:ap-northeast-1:505982390831:function:StoreTksd/invocations"
  credentials             = "arn:aws:iam::505982390831:role/shusys-API-Lambda-role"
  passthrough_behavior    = "WHEN_NO_MATCH"
}
...
resource "aws_api_gateway_integration" "storetkyd-post" {
  ...
  integration_http_method = "POST"
  type                    = "AWS_PROXY"
  uri                     = "arn:aws:apigateway:ap-northeast-1:lambda:path/2015-03-31/functions/arn:aws:lambda:ap-northeast-1:505982390831:function:StoreTkyd/invocations"
  credentials             = "arn:aws:iam::505982390831:role/shusys-API-Lambda-role"
  passthrough_behavior    = "WHEN_NO_MATCH"
}
