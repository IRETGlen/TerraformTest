...
variable "appstream_vpce_name" {
  description = "The name of the VPC Endpoint for AppStream"
  type        = string
}

variable "s3_vpce_name" {
  description = "The name of the VPC Endpoint for S3"
  type        = string
}