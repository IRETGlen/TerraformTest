...
###############################################################################
output "hyoka_rds_security_group" {
  value       = aws_security_group.hyoka_rds_security_group.id
  description = "RDS Security Group"
}

output "hyoka_lambda_security_group" {
  value       = aws_security_group.hyoka_lambda_security_group.id
  description = "Lambda Security Group"
}

output "hyoka_appstream_image_security_group" {
  value       = aws_security_group.hyoka_appstream_image_security_group.id
...
# VPC Endpoint Output
###############################################################################
output "hyoka_apigw_vpc_endpoint" {
  value       = module.apigw_vpc_endpoint.endpoint_ids
...
output "summary" {
  ...
  |----------------------------------|----------------------|
  | ${var.app_name_env_code}-rds-SG | ${aws_security_group.hyoka_rds_security_group.id} |
