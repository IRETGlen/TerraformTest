...
###############################################################################
output "datanavi_dev_lambda_security_group" {
  value       = aws_security_group.datanavi_dev_lambda_security_group.id
...
output "summary" {
  ...
  | ${var.app_name_env_code}-${element(var.private_subnet_names,0)}1  | ${element(module.base_network.public_subnets,1)} |


  ## Security Groups
  | SecurityGroup Name | SecurityGroup ID|
  |----------------------------------|----------------------|
  | ${var.app_name_env_code}-lambda-sg | ${aws_security_group.datanavi_dev_lambda_security_group.id} |
