...
###############################################################################
output "datanavi_stg_lambda_security_group" {
  value       = aws_security_group.datanavi_stg_lambda_security_group.id
...
output "summary" {
  ...
  |----------------------------------|----------------------|
  | ${var.app_name_env_code}-lambda-sg | ${aws_security_group.datanavi_stg_lambda_security_group.id} |
